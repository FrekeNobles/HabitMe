        ...
        <form data-testid="habit-form" onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 py-2.5 border border-gray-200 text-gray-700 font-medium rounded hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed transition-smooth"
            >
              Cancel
            </button>
            <button
              ...
              disabled={isLoading}
              className="flex-1 py-2.5 bg-black text-white font-medium rounded hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed transition-smooth"
            >
